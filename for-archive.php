...
$rename = time();
                      if ($_FILES["pdf_file"]["name"] != "") {
                        ...
                        $newname = $rename.'1.'.$rann;
                        $folder1 = "upload/".$newname;
                        move_uploaded_file($_FILES["pdf_file"]["tmp_name"],$folder1);   
                        }else{
                        ...
                        $newname1 = $rename.'2.'.$rann;
                        $folder1 = "upload/".$newname1;
                        move_uploaded_file($_FILES["epub_file"]["tmp_name"],$folder1);   
                        }else{
                        ...
                        $newname2 = $rename.'3.'.$rann;
                        $folder2 = "upload/".$newname2;
                        move_uploaded_file($_FILES["flip_file"]["tmp_name"],$folder2);   
                        }else{
